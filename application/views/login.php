...
<body class="light_theme  fixed_header left_nav_fixed" style="background-color:#6C0; background-image:url(<?php echo base_url();?>assets/images/_MG_5965.jpg);background-size: 1400px 820px;
...
<div class="wrapper">
  ...
  <div class="panel-heading">
  	  <span style="font-size: 18px; color:#690;">Vehicle Entry Exit Management System</span>
  </div>	
 ...
 <form role="form" class="form-horizontal"action="<?php echo base_url(); ?>welcome/login/" method="post">
      ...
      <span style="font-size:10px;">Copyright © 2016 VIYELLATEXGROUP All rights reserved.</span>
